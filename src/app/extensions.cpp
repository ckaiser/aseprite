...
Extensions::Extensions()
{
  ...
  while (rf.next()) {
    ...
    loadDirectory(extensionsDir);
  }
}

Extensions::Extensions(const std::string& extensionsDir)
{
  loadDirectory(extensionsDir);
  m_userExtensionsPath = extensionsDir;
}
...
void Extensions::loadDirectory(const std::string& extensionsDir)
{
